...
scf1998 = pd.read_stata('p98i6.dta')
scf1995 = pd.read_stata('p95i6.dta')
scf1992 = pd.read_stata('p92i4.dta')
scf1989 = pd.read_stata('p89i6.dta')
...
def initSCFvars(scf, year):
	...
	age = scf2013['X8022'][indeces]
	income =scf2013['X5729'][indeces]
...
def income_plot(total_bequest_matrix_filled, income_y, year):
	...
	plt.ylabel('percentage share of total received inheritances; 1=%100')
	plt.title('Received percentage share of total bequests with income for year {}'.format(str(year)))
	plt.show()
...
age_income6, total_bequests_received6, age_income_matrix6, total_bequest_matrix6 = initSCFvars(scf1998, year1998)
age_income_matrix_filled6, total_bequest_matrix_filled6 = genBequestMatrix(age_income_matrix6, total_bequest_matrix6, \
	age_groups, income_groups, min_age, income_levels, age_income6, year1998)
proportion_matrix6 = genProportionMat(age_groups, income_groups, total_bequest_matrix_filled6, total_bequests_received6)

age_income7, total_bequests_received7, age_income_matrix7, total_bequest_matrix7 = initSCFvars(scf1995, year1995)
age_income_matrix_filled7, total_bequest_matrix_filled7 = genBequestMatrix(age_income_matrix7, total_bequest_matrix7, \
	age_groups, income_groups, min_age, income_levels, age_income7, year1995)
proportion_matrix7 = genProportionMat(age_groups, income_groups, total_bequest_matrix_filled7, total_bequests_received7)

age_income8, total_bequests_received8, age_income_matrix8, total_bequest_matrix8 = initSCFvars(scf1992, year1992)
age_income_matrix_filled8, total_bequest_matrix_filled8 = genBequestMatrix(age_income_matrix8, total_bequest_matrix8, \
	age_groups, income_groups, min_age, income_levels, age_income8, year1992)
proportion_matrix8 = genProportionMat(age_groups, income_groups, total_bequest_matrix_filled8, total_bequests_received8)

age_income9, total_bequests_received9, age_income_matrix9, total_bequest_matrix9 = initSCFvars(scf1989, year1989)
age_income_matrix_filled9, total_bequest_matrix_filled9 = genBequestMatrix(age_income_matrix9, total_bequest_matrix9, \
	age_groups, income_groups, min_age, income_levels, age_income9, year1989)
proportion_matrix9 = genProportionMat(age_groups, income_groups, total_bequest_matrix_filled9, total_bequests_received9)

all_summed_total_bequests = total_bequests_received+total_bequests_received2+total_bequests_received3+total_bequests_received4+total_bequests_received5+total_bequests_received6+total_bequests_received7+total_bequests_received8+total_bequests_received9
all_summed_total_bequests_mat = total_bequest_matrix_filled+total_bequest_matrix_filled2+total_bequest_matrix_filled3+total_bequest_matrix_filled4+total_bequest_matrix_filled5+total_bequest_matrix_filled6+total_bequest_matrix_filled7+total_bequest_matrix_filled8+total_bequest_matrix_filled9
...
# print "here are the bequests over age :{}".format(total_bequest_matrix_filled9.sum(axis = 1))
# print "here are the bequests over age :{}".format(total_bequest_matrix_filled8.sum(axis = 1))
# print "here are the bequests over age :{}".format(total_bequest_matrix_filled7.sum(axis = 1))
# print "here are the bequests over age :{}".format(total_bequest_matrix_filled6.sum(axis = 1))
# print "here are the bequests over age :{}".format(total_bequest_matrix_filled5.sum(axis = 1))
# print "here are the bequests over age :{}".format(total_bequest_matrix_filled4.sum(axis = 1))
# print "here are the bequests over age :{}".format(total_bequest_matrix_filled3.sum(axis = 1))
# print "here are the bequests over age :{}".format(total_bequest_matrix_filled2.sum(axis = 1))
# print "here are the bequests over age :{}".format(total_bequest_matrix_filled.sum(axis = 1))

# print "here are the bequests over income :{}".format(total_bequest_matrix_filled9.sum(axis = 0))
# print "here are the bequests over income :{}".format(total_bequest_matrix_filled8.sum(axis = 0))
# print "here are the bequests over income :{}".format(total_bequest_matrix_filled7.sum(axis = 0))
# print "here are the bequests over income :{}".format(total_bequest_matrix_filled6.sum(axis = 0))
# print "here are the bequests over income :{}".format(total_bequest_matrix_filled5.sum(axis = 0))
# print "here are the bequests over income :{}".format(total_bequest_matrix_filled4.sum(axis = 0))
# print "here are the bequests over income :{}".format(total_bequest_matrix_filled3.sum(axis = 0))
# print "here are the bequests over income :{}".format(total_bequest_matrix_filled2.sum(axis = 0))
# print "here are the bequests over income :{}".format(total_bequest_matrix_filled.sum(axis = 0))
...
age_income_plot(income_y, age_groups, proportion_matrix6, year1998)
age_income_plot(income_y, age_groups, proportion_matrix7, year1995)
age_income_plot(income_y, age_groups, proportion_matrix8, year1992)
age_income_plot(income_y, age_groups, proportion_matrix9, year1989)
...
age_plot(total_bequest_matrix_filled6, age_groups, year1998)
age_plot(total_bequest_matrix_filled7, age_groups, year1995)
age_plot(total_bequest_matrix_filled8, age_groups, year1992)
age_plot(total_bequest_matrix_filled9, age_groups, year1989)
...
income_plot(total_bequest_matrix_filled6, income_y, year1998)
income_plot(total_bequest_matrix_filled7, income_y, year1995)
income_plot(total_bequest_matrix_filled8, income_y, year1992)
income_plot(total_bequest_matrix_filled9, income_y, year1989)
